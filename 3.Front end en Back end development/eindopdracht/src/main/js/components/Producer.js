...
class Producer extends React.Component {
    ...
    render() {
        return (
            ...
            <Nav {...this.props}/>
                <div className="grid">
                    <Upload currentUser={this.state.currentUser} addFile={this.getUploads}/>
                    <PlayList {...this.props} uploads={this.state.uploads} currentFileId={this.state.currentFileId} setCurrentFileId={this.setCurrentFileId} />
                    <Comments {...this.props} currentUser={this.state.currentUser} currentFileId={this.state.currentFileId}/>
                </div>
            </div>
        );
    }
